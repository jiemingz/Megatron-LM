...
class OffloadTensorGroup:
    ...
    def __init__(self, name):
        self._name = name
        self._tensors = {}
        self._offload_event = torch.cuda.Event(external=True)
        self._reload_event = torch.cuda.Event(external=True)
        self.offload = True
...
class ChunkOffloadHandler:
    ...
    def on_group_commit_backward(self, name):
        ...
        # Note: wait_event is capturable, so this synchronization is captured into the graph
